...
IF EXISTS (	SELECT *
			...
			WHERE ROUTINE_NAME = 'GET_ALL_CUSTOMER'
				AND ROUTINE_TYPE = 'PROCEDURE' )
BEGIN
	PRINT 'Dropping stored procedure GET_ALL_CUSTOMER.';
	DROP PROCEDURE GET_ALL_CUSTOMER;
END
...
IF EXISTS (	SELECT *
			...
			WHERE ROUTINE_NAME = 'GET_ALL_CUSTOMER'
				AND ROUTINE_TYPE = 'PROCEDURE' )
BEGIN
	PRINT 'Stored procedure GET_ALL_CUSTOMER created successfully.';	
END
ELSE
BEGIN
	PRINT 'ERROR: Failed to create stored procedure GET_ALL_CUSTOMER.';
END
GO
