...
IF EXISTS (	SELECT *
			...
			WHERE ROUTINE_NAME = 'GET_ALL_EMPLOYEE'
				AND ROUTINE_TYPE = 'PROCEDURE' )
BEGIN
	PRINT 'Dropping stored procedure GET_ALL_EMPLOYEE.';
	DROP PROCEDURE GET_ALL_EMPLOYEE;
END
...
IF EXISTS (	SELECT *
			...
			WHERE ROUTINE_NAME = 'GET_ALL_EMPLOYEE'
				AND ROUTINE_TYPE = 'PROCEDURE' )
BEGIN
	PRINT 'Stored procedure GET_ALL_EMPLOYEE created successfully.';	
END
ELSE
BEGIN
	PRINT 'ERROR: Failed to create stored procedure GET_ALL_EMPLOYEE.';
END
GO
